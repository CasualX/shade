...
impl dto::Widget {
	pub fn construct(self, scene: &mut Scene, ctx: &mut dto::BuildContext) -> SlotKey {
		match self {
			...
			dto::Widget::Menu(dto) => dto.construct(scene, ctx),
			dto::Widget::MenuBar(dto) => dto.construct(scene, ctx),
			dto::Widget::MenuBarItem(dto) => dto.construct(scene, ctx),
			dto::Widget::MenuItem(dto) => dto.construct(scene, ctx),
			...
			dto::Widget::Separator(dto) => dto.construct(scene, ctx),
