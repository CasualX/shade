...
fn gl_attributes(shader: &WebGLShaderProgram, data: &[crate::DrawVertexBuffer<'_>]) -> u32 {
...
fn gl_immediate_fbo(this: &mut WebGLGraphics, color: &[&dyn crate::Texture2D], levels: Option<&[u8]>, depth: Option<&dyn crate::Texture2D>) {
